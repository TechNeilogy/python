...
weights = {
    'h1':  tf.Variable(tf.random_uniform(shape=(n_input,    n_hidden_1),minval=0, maxval=0.01, dtype=tf.float32, seed=0)),
    'h2':  tf.Variable(tf.random_uniform(shape=(n_hidden_1, n_hidden_2),minval=0, maxval=0.01, dtype=tf.float32, seed=0)),
    ...
    'out': tf.Variable(tf.random_uniform(shape=(n_hidden_2, n_classes), minval=0, maxval=0.01, dtype=tf.float32, seed=0))
}
